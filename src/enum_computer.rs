pub mod enum_comp { 
    ...
    // Return the PowerShell version available on the machine
    ...
    // Get all the processes running on the machine with their status, name and paths
    pub fn processes()
    {
        let sys = System::new_all();
        println!("\n • RUNNING PROCESSES \n");
